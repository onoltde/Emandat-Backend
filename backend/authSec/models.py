...
class Competitions(models.Model):
    ...
    organizer = models.ForeignKey(User, related_name='competitions', on_delete=models.CASCADE)
...
class Profiles(models.Model):
    ...
    registeredcompetitions = models.ManyToManyField(Competitions, related_name='profiles', blank=True)
